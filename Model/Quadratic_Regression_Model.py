...
inputs = Quadratic(n_points = 50, a = 2.0, b = 3.0, c = 5.0, noise_std=2.0)
X = inputs.X
Y = inputs.Y
plt.scatter(X, Y, s = 5)
plt.show()
...
quadratic_model.set(loss = Model.Loss_MeanSquaredError(), optimizer = Model.Optimizer_Adam(learning_rate=0.01), accuracy = None)
